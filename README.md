...
Neste repositório, reunimos informações sobre diversos títulos, fornecendo sinopses envolventes, trailers emocionantes e instruções sobre como assistir a cada produção. Descubra novas histórias, mergulhe em mundos fascinantes e desfrute do entretenimento de alta qualidade que selecionamos para você.
...
Este arquivo contém informações sobre o fluxo de "branches". Todos os nossos commits e branches foram escritos em inglês.

- docs/
  - initial-config / feat-add-captain-fastastic (Bruno Scarpari)
  - feat-add-one-piece (Kevin Matos)
  - feat-add-zelda (Rodrigo Carvalho)
  - feat-add-o-contador (Janier Freitas)
  - feat-add-interestelar (Raphael Baere)
  - feat-add-pica-pau-o-filme (Gabriel Sales)
...
- [x] Criou o sexto conteúdo (Capitão Fantástico) - Bruno Scarpari
